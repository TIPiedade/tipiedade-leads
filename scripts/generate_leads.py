...
PREHEADERS = {
    "restaurante": {
        1: "Receita simples: congelado → forno → mesa. 4 minutos. Sem falhas.",
        2: "Um caso real de como eliminar quebras e aumentar a margem em sobremesas.",
        3: "Os clientes estão a pedir mais — e os restaurantes que respondem ganham.",
        4: "10 minutos é tudo o que pedimos. Trazemos as amostras.",
    },
    "hotel": {
        1: "Do congelador ao prato em 4 minutos. Qualidade artesanal, zero stress.",
        2: "Um caso real de como um hotel simplificou o F&B sem perder qualidade.",
        3: "O que os hóspedes pedem e os hotéis que já respondem têm em comum.",
        4: "A equipa de F&B vai adorar. Trazemos amostras para experimentar.",
    },
    "pastelaria": {
        1: "40 anos de tradição, prontos a complementar a vossa montra.",
        2: "Mais rotação, mais margem — sem aumentar a produção própria.",
        3: "O que as pastelarias de referência em Portugal têm em comum.",
        4: "Podemos passar com amostras esta semana — quando é melhor?",
    },
    "catering": {
        1: "Sobremesa artesanal que impressiona — sem pasteleiro na equipa.",
        2: "Como simplificar a sobremesa em eventos sem perder o 'uau'.",
        3: "O detalhe que os clientes mais comentam nos eventos.",
        4: "Queremos mostrar-vos em pessoa. Trazemos amostras.",
    },
    "distribuidor": {
        1: "Alta rotação, margem real, produto que se vende sozinho.",
        2: "Casos reais de distribuidores que adicionaram o Ti'Piedade ao portfólio.",
        3: "O congelado artesanal que está a crescer nos lineares portugueses.",
        4: "Podemos reunir para apresentar condições comerciais — quando é possível?",
    },
    "gourmet": {
        1: "Um artesanal com 40 anos que combina com tudo o que vendem.",
        2: "Como uma mercearia gourmet aumentou o ticket médio com sobremesas.",
        3: "O produto português que os clientes continuam a pedir.",
        4: "Trazemos amostras para experimentar — sem compromisso.",
    },
    "cafe": {
        1: "O lanche que os clientes vão pedir de novo — e recomendar.",
        2: "Como aumentar a conta média sem mudar o que já funciona.",
        3: "A sobremesa artesanal que está nos melhores cafés do país.",
        4: "Podemos passar com amostras. Quando é boa altura?",
    },
    "cervejaria": {
        1: "A sobremesa que fecha qualquer refeição com distinção.",
        2: "Como uma cervejaria aumentou a satisfação sem complicar a cozinha.",
        3: "O que os clientes mais comentam quando saem satisfeitos.",
        4: "Queremos passar com amostras para a equipa provar.",
    },
}
...
def corpo_html(email_num, grupo, nome_lead, zona, nome_comercial, texto_plain):
    ...
    nome_enc = _up.quote(nome_lead or "")
    preheader_text = PREHEADERS.get(grupo, PREHEADERS.get("restaurante", {})).get(email_num, "Pão de Ló Ti'Piedade — artesanal desde 1984.")
    ...
    # Capitalizar início da frase se necessário
    frase_cap = frase[0].upper() + frase[1:] if frase and not frase[0].isupper() else frase
    intro  = frase_cap if frase_cap.lower().startswith("bom dia") else (
        f"Bom dia,<br><br>O meu nome é <strong>Rui Bernardes</strong> e faço parte da equipa "
        f"comercial do <strong>Pão de Ló Ti'Piedade</strong>.<br><br>{frase_cap}"
    )
...
<!-- PREHEADER: texto de pré-visualização invisível no email -->
<div style="display:none;max-height:0;overflow:hidden;font-size:1px;line-height:1px;color:#F0E8DC;mso-hide:all">
  {preheader_text}&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;&nbsp;&#847;
</div>
...
<table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%">
  ...
  <tr><td style="padding:12px 36px;text-align:center;border-top:1px solid #e8d5b8">
    <p style="margin:0;font-size:10px;color:#aaa;line-height:1.6">
      Recebeu este email porque o seu estabelecimento foi identificado como potencial parceiro comercial da Pão de Ló Ti'Piedade.<br>
      Caso não pretenda receber mais comunicações, <a href="mailto:sales@tipiedade.com?subject=Cancelar%20emails%20-%20{nome_enc}&body=Bom%20dia%2C%0D%0APretendo%20cancelar%20o%20envio%20de%20emails%20da%20Ti%27Piedade%20para%20este%20endere%C3%A7o.%0D%0AObrigado."
      style="color:#D4682A;text-decoration:underline;font-weight:600">cancele a subscrição aqui</a>.
    </p>
  </td></tr>
</table></td></tr></table>
</body></html>"""
