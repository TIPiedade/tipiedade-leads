...
def corpo_html(email_num, grupo, nome_lead, zona, nome_comercial, texto_plain):
    ...
    subtitulo = SUBTITULOS.get(email_num, "")

    # Assuntos por grupo
    assuntos_g = {
        "restaurante":{1:"Uma sobremesa portuguesa que se vende sozinha",2:"Como eliminar as quebras em sobremesas",3:"O que está a mudar nas cartas de sobremesa",4:"Queremos passar — leva 10 minutos"},
        "hotel":      {1:"Sobremesa artesanal para o vosso F&B",2:"Qualidade constante sem pasteleiro",3:"O que os hóspedes estão a pedir",4:"Podemos passar com amostras"},
        "pastelaria": {1:"Um artesanal com 40 anos para a vossa vitrina",2:"Como diferenciar com o Ti'Piedade",3:"Produto com margem e sem esforço",4:"Queremos deixar amostras"},
        "catering":   {1:"Sobremesa elegante para os vossos eventos",2:"Como funciona em casamentos premium",3:"O que mais impressiona nos eventos",4:"Reunião para apresentar condições"},
        "distribuidor":{1:"Referência premium para a vossa carteira",2:"Marca com 40 anos em crescimento",3:"Margem interessante, zonas por cobrir",4:"Apresentação das condições comerciais"},
        "gourmet":    {1:"40 anos de receita artesanal para a vossa prateleira",2:"Como mercearias se estão a diferenciar",3:"Produto com narrativa que se vende",4:"Visita para mostrar o produto"},
        "cafe":       {1:"O pairing perfeito para o vosso café",2:"Como aumentar o ticket médio",3:"Produto artesanal que o vosso público valoriza",4:"Amostras para a vossa equipa"},
        "cervejaria": {1:"A sobremesa que fecha qualquer refeição",2:"Zero desperdício em grande volume",3:"Custo previsível e margem alta",4:"Amostras e apresentação de condições"},
    }
    titulo_email = (assuntos_g.get(grupo, assuntos_g["restaurante"])).get(email_num, "")

    # Benefícios visuais por tipologia
    BENEFICIOS = {
        "restaurante": [
            ("🇵🇹", "Produto português", "Receita artesanal com 40 anos — os clientes reconhecem e pedem"),
            ("❄️", "Congelado em dose individual", "Sem desperdício — serve só o que precisa, quando precisa"),
            ("👨‍🍳", "Sem pasteleiro", "Descongela em minutos, vai directo ao prato"),
            ("💰", "Margem confortável", "4 sabores: Original, Chocolate, Canela e Café"),
        ],
        "hotel": [
            ("🏆", "Qualidade constante", "Artesanal e consistente — independente do volume ou turno"),
            ("❄️", "Dose individual congelada", "Zero preparação — descongela e serve, sem perdas"),
            ("🌍", "Para hóspedes internacionais", "Receita levada pelos portugueses ao Japão no séc. XVI"),
            ("☕", "Versátil", "Restaurante, pequeno-almoço, room service ou eventos"),
        ],
        "pastelaria": [
            ("🥐", "Complemento, não concorrente", "Referência nacional que os clientes já conhecem"),
            ("❄️", "Dose individual pronta", "Controlo de stock sem perdas — vai directo ao balcão"),
            ("📜", "Receita secular", "Ingredientes simples, sem conservantes, origem verificável"),
            ("💰", "Margem de revenda", "4 sabores: Original, Chocolate, Canela e Café"),
        ],
        "catering": [
            ("🎪", "Para qualquer evento", "Casamentos, corporativos, galas — até 1000+ convidados"),
            ("❄️", "Zero logística", "Dose individual — sem corte, sem preparação, sem perdas"),
            ("✨", "Experiência de qualidade", "Produto artesanal com história que fica na memória"),
            ("📦", "Volume com qualidade", "4 sabores: Original, Chocolate, Canela e Café"),
        ],
        "distribuidor": [
            ("🚛", "Alta rotação", "Procura crescente no canal HORECA em todo o país"),
            ("💰", "Margem de distribuição", "Condições comerciais por volume, MOQ negociável"),
            ("🗺️", "Zonas com potencial", "Regiões sem cobertura e clientela identificada"),
            ("📜", "Marca com história", "40 anos, terceira geração, reconhecimento nacional"),
        ],
        "gourmet": [
            ("📜", "Narrativa de produto", "40 anos de receita intacta — conta-se em duas frases"),
            ("🇵🇹", "Origem verificável", "Produção familiar portuguesa, ingredientes simples"),
            ("❄️", "Fácil de gerir", "Congelado individual — sem risco de validade, sem perdas"),
            ("✨", "Premium acessível", "4 sabores: Original, Chocolate, Canela e Café"),
        ],
        "cafe": [
            ("☕", "Pairing natural", "Pão de ló artesanal + café de especialidade — combinação perfeita"),
            ("💰", "Ticket médio mais alto", "Produto de impulso com margem elevada ao balcão"),
            ("📜", "Produto com história", "Receita que o barista explica em duas frases"),
            ("❄️", "Sem desperdício", "Dose individual — serve só o que precisa"),
        ],
        "cervejaria": [
            ("⚡", "Rapidez total", "Do congelador ao prato — zero preparação, zero espera"),
            ("❄️", "Zero desperdício", "Dose individual — custo fixo e previsível por sobremesa"),
            ("💰", "Margem elevada", "PVP atrativo com margem superior ao pudim ou mousse"),
            ("🇵🇹", "Os clientes pedem", "Reconhecida como sobremesa portuguesa de sempre"),
        ],
    }

    bens = BENEFICIOS.get(grupo, BENEFICIOS["restaurante"])

    # Textos de introdução e CTA por email
    INTRO = {
        1: f"Bom dia,<br><br>O meu nome é <strong>Rui Bernardes</strong>, do Departamento Comercial do <strong>Pão de Ló Ti'Piedade</strong>.<br><br>Identificámos <strong>{nome_lead}</strong> como um espaço com o perfil certo para o nosso produto e gostaríamos de nos apresentar brevemente.",
        2: f"Bom dia,<br><br>Na semana passada apresentámos o <strong>Pão de Ló Ti'Piedade</strong>.<br><br>Hoje partilhamos um caso real de um espaço semelhante ao vosso — porque acreditamos que os resultados falam melhor do que qualquer apresentação.",
        3: f"Bom dia,<br><br>Uma tendência que estamos a observar no setor e que achamos relevante partilhar convosco.",
        4: f"Bom dia,<br><br>Ao longo das últimas semanas partilhámos a história do Ti'Piedade e alguns casos reais.<br><br>Esta semana gostaríamos de passar por <strong>{nome_lead}</strong> para deixar amostras — sem compromisso, só para provarem.",
    }

    CTA = {
        1: ("✉️ Responder", "mailto:sales@tipiedade.com", "#5C2D0E", "Ficamos ao dispor para qualquer questão ou para agendar uma visita."),
        2: ("📞 Saber mais", "mailto:sales@tipiedade.com", "#D4682A", "Se quiser perceber como isto pode funcionar no vosso espaço, estamos disponíveis."),
        3: ("💡 Vamos conversar?", "mailto:sales@tipiedade.com", "#5C2D0E", "Podemos passar pela vossa zona na próxima semana."),
        4: ("📅 Agendar visita", "mailto:sales@tipiedade.com", "#1A6B3A", "Responda a este email ou contacte-nos directamente em sales@tipiedade.com."),
    }

    intro_txt = INTRO.get(email_num, INTRO[1])
    cta_label, cta_href, cta_cor, cta_sub = CTA.get(email_num, CTA[1])

    # Gerar blocos de benefícios com ícone
    bens_html = ""
    for ico, titulo, desc in bens:
        bens_html += f"""
        <tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td width="48" style="vertical-align:top;padding-right:14px">
                  <div style="width:44px;height:44px;background:#FDF6EF;border:1px solid #E8D5B8;border-radius:10px;text-align:center;line-height:44px;font-size:22px">{ico}</div>
                </td>
                <td style="vertical-align:top">
                  <p style="margin:0;font-size:13px;font-weight:700;color:#4a2417">{titulo}</p>
                  <p style="margin:3px 0 0;font-size:12px;color:#6B5744;line-height:1.5">{desc}</p>
                </td>
              </tr>
            </table>
          </td>
    ...
    # Email 2 — adicionar bloco de caso real em vez dos benefícios
    if email_num == 2:
        casos = {
            "restaurante": ("🍽 Restaurante · Costa de Lisboa", "Introduziu o Ti'Piedade há 2 meses", ["Passou a ser a sobremesa mais pedida da carta", "Desperdício em sobremesas: zero", "Margem por sobremesa superior à tarte e ao pudim"]),
            "hotel":       ("🏨 Hotel 4★ · Região Centro",      "Introduziu o Ti'Piedade há 3 meses", ["Room service com sobremesa artesanal sem pasteleiro", "Consistência de qualidade em qualquer volume", "Hóspedes internacionais identificam e pedem"]),
            "pastelaria":  ("🥐 Pastelaria · Lisboa",             "Introduziu o Ti'Piedade há 4 meses", ["Tornou-se referência de venda por impulso ao balcão", "Controlo de stock sem perdas", "Clientes reconhecem a marca — não é preciso explicar"]),
            "catering":    ("🎪 Catering · Casamentos · Porto",  "Usa o Ti'Piedade há 6 meses",        ["Eventos com 200+ convidados sem logística de corte", "Sobremesa que fica na memória dos convidados", "Zero improvisação em dias de evento"]),
            "gourmet":     ("🫙 Mercearia Gourmet · Cascais",    "Introduziu o Ti'Piedade há 3 meses", ["Referência de doçaria nacional no espaço", "Clientes compram sem que seja necessário explicar", "Stock sem risco de validade"]),
            "cafe":        ("☕ Café de Especialidade · Lisboa",  "Introduziu o Ti'Piedade há 2 meses", ["Produto de tarde mais vendido: café + pão de ló", "Desperdício zero vs. bolos inteiros", "Ticket médio da tarde subiu"]),
            "cervejaria":  ("🍺 Cervejaria · Lisboa",             "Introduziu o Ti'Piedade há 4 meses", ["Sobremesa mais vendida acima de mousse e pudim", "Desperdício em sobremesas: zero", "Margem por sobremesa aumentou"]),
            "distribuidor":("🚛 Distribuidor · Norte de Portugal","Parceiro há 8 meses",                ["Referência mais pedida pelos clientes HORECA", "Rotação previsível e estável", "Margem de distribuição competitiva"]),
        }
        caso = casos.get(grupo, casos["restaurante"])
        bens_html = f"""
        <tr><td style="padding:0 0 16px">
          <div style="background:#FDF6EF;border:1px solid #E8D5B8;border-radius:12px;padding:18px 20px">
            <p style="margin:0;font-size:12px;font-weight:700;color:#C49A3C;letter-spacing:.06em;text-transform:uppercase">Caso real</p>
            <p style="margin:6px 0 0;font-size:14px;font-weight:700;color:#4a2417">{caso[0]}</p>
            <p style="margin:3px 0 10px;font-size:12px;color:#6B5744">{caso[1]}</p>
            {"".join(f'<p style="margin:4px 0;font-size:12px;color:#2C1A0A"><span style="color:#1A6B3A;font-weight:700">✓</span> {r}</p>' for r in caso[2])}
          </div>
        </td></tr>"""

    # Email 3 — bloco de tendência
    if email_num == 3:
        bens_html = f"""
        <tr><td style="padding:0 0 16px">
          <div style="background:#FDF6EF;border-left:4px solid #C49A3C;border-radius:0 10px 10px 0;padding:16px 18px">
            <p style="margin:0;font-size:13px;font-weight:700;color:#4a2417">O que está a mudar no mercado</p>
            <p style="margin:8px 0 0;font-size:12px;color:#2C1A0A;line-height:1.6">Os clientes pedem cada vez mais <strong>produtos com história e origem</strong>. A doçaria industrial está a perder terreno para o artesanal verificável.</p>
            <p style="margin:10px 0 0;font-size:12px;color:#2C1A0A;line-height:1.6">Ao mesmo tempo, os operadores precisam de <strong>simplicidade</strong> — sem pasteleiro, sem desperdício, sem imprevistos.</p>
          </div>
          <div style="margin-top:12px;background:#fff;border:1px solid #E8D5B8;border-radius:10px;padding:14px 18px">
            <p style="margin:0;font-size:12px;font-weight:700;color:#4a2417">O Ti'Piedade resolve os dois lados</p>
            <table width="100%" cellpadding="0" cellspacing="0" style="margin-top:10px">
              <tr>
                <td width="50%" style="padding-right:8px;vertical-align:top">
                  <p style="margin:0;font-size:11px;font-weight:700;color:#C49A3C;text-transform:uppercase;letter-spacing:.06em">Para o cliente</p>
                  <p style="margin:4px 0 0;font-size:12px;color:#2C1A0A;line-height:1.5">Produto artesanal com 40 anos de história que os portugueses reconhecem</p>
                </td>
                <td width="50%" style="padding-left:8px;vertical-align:top;border-left:1px solid #E8D5B8">
                  <p style="margin:0;font-size:11px;font-weight:700;color:#C49A3C;text-transform:uppercase;letter-spacing:.06em">Para o operador</p>
                  <p style="margin:4px 0 0;font-size:12px;color:#2C1A0A;line-height:1.5">Dose individual congelada — zero preparação, zero desperdício, margem previsível</p>
                </td>
              </tr>
            </table>
          </div>
    ...
    if email_num == 4:
        bens_html = f"""
        <tr><td style="padding:0 0 16px">
          <div style="background:#FDF6EF;border-radius:12px;padding:20px;text-align:center">
            <p style="margin:0;font-size:32px">🎁</p>
            <p style="margin:10px 0 4px;font-size:15px;font-weight:700;color:#4a2417">Amostras gratuitas para provar</p>
            <p style="margin:0;font-size:12px;color:#6B5744;line-height:1.5">4 sabores · Original · Chocolate · Canela · Café</p>
            <p style="margin:12px 0 0;font-size:12px;color:#2C1A0A;line-height:1.6">Sem compromisso. Sem reunião formal.<br>Só o produto, para a vossa equipa provar e avaliar.</p>
          </div>
        </td></tr>"""
...
<table width="100%" cellpadding="0" cellspacing="0" style="background:#F0E8DC;padding:28px 0">
<tr><td align="center">
<table width="580" cellpadding="0" cellspacing="0" style="max-width:580px;width:100%">

  <!-- HEADER -->
  <tr><td style="background:#4a2417;border-radius:16px 16px 0 0;padding:26px 36px 20px;text-align:center">
    <img src="{LOGO_WHITE}" alt="Ti'Piedade" style="height:58px;display:block;margin:0 auto;border:0">
    <div style="height:2px;background:linear-gradient(90deg,transparent,#C49A3C 30%,#D4682A 70%,transparent);margin-top:16px;border-radius:2px"></div>
  </td></tr>
  ...
  <!-- INTRO -->
  <tr><td style="background:#ffffff;padding:28px 36px 0;border-left:1px solid #DDD0BB;border-right:1px solid #DDD0BB">
    <p style="margin:0;font-size:13px;color:#2C1A0A;line-height:1.7">{intro_txt}</p>
  </td></tr>
  ...
  <tr><td style="background:#ffffff;padding:0 36px;border-left:1px solid #DDD0BB;border-right:1px solid #DDD0BB">
    ...
    <p style="margin:0 0 16px;font-size:11px;font-weight:700;color:#C49A3C;letter-spacing:.1em;text-transform:uppercase">Porquê o Ti'Piedade?</p>
  </td></tr>
  ...
  <!-- CTA -->
  <tr><td style="background:#ffffff;padding:20px 36px 28px;border-left:1px solid #DDD0BB;border-right:1px solid #DDD0BB">
    <div style="height:1px;background:#E8D5B8;margin-bottom:20px"></div>
    <p style="margin:0 0 12px;font-size:12px;color:#6B5744;line-height:1.6">{cta_sub}</p>
    <table cellpadding="0" cellspacing="0">
      <tr><td style="background:{cta_cor};border-radius:8px">
        <a href="{cta_href}?subject=Ti'Piedade — Interesse" style="display:block;padding:11px 24px;color:#fff;font-size:13px;font-weight:700;text-decoration:none">{cta_label}</a>
      </td></tr>
    </table>
  </td></tr>
  ...
  <tr><td style="background:#FDF6EF;padding:16px 36px;border:1px solid #DDD0BB;border-top:none">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="vertical-align:middle">
        <p style="margin:0;font-size:11px;font-weight:700;color:#C49A3C;letter-spacing:.08em;text-transform:uppercase">O produto</p>
        <p style="margin:3px 0 0;font-size:13px;font-weight:700;color:#4a2417">Pão de Ló Ti'Piedade · Unidose 85g (congelado)</p>
  ...
  <tr><td style="background:#4a2417;border-radius:0 0 16px 16px;padding:14px 36px">
    <table width="100%" cellpadding="0" cellspacing="0"><tr>
      <td style="vertical-align:middle">
        <p style="margin:0;font-size:11px;color:#C49A3C;font-weight:600">sales@tipiedade.com</p>
        <p style="margin:1px 0 0;font-size:10px;color:rgba(255,255,255,.4)">www.tipiedade.com</p>
      </td>
      <td align="right" style="vertical-align:middle">
        <a href="https://www.tipiedade.com" style="font-size:10px;font-weight:700;color:#C49A3C;text-decoration:none;border:1px solid rgba(196,154,60,.4);padding:5px 12px;border-radius:5px;white-space:nowrap">Ver produto ↗</a>
      </td>
    </tr></table>
  </td></tr>
